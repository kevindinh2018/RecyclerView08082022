...
import com.example.recyclerview08082022.CategoryEnum;
import com.kevindinh.recyclerview08082022.R;
...
public class Food {
    ...
    private List<com.example.recyclerview08082022.CategoryEnum> categoryEnums;
    ...
    public Food(int image, String name, String address, List<com.example.recyclerview08082022.CategoryEnum> categoryEnums, String saleOff, float distance, int hourOpenTime, int minutesOpenTime, int hourCloseTime, int minutesCloseTime) {
        this.image = image;
        this.name = name;
